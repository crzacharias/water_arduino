...
#define arquivo "dataAG.txt" //file name, to be saved on SD card
#define arquivo2 "007AG.txt"  //L
...
int delaydripon  = 15000;  // drip system on (watering): 1.5 minutes
int delaydripoff = 1000;  // drip system off (diffusion): 10 minutes
...
int Dp = 0;  //L  0 ou 1 do drip no SD
int Spk = 0;  //L 0 ou 1 do sprinkler no SD
...
*/
  ...
  if(arq) {   
    arq.print("Date"); arq.print("\t\t"); arq.print("Hour"); arq.print("\t");
    arq.print("US"); arq.print("\t\t");
    arq.print("L2"); arq.print("\t\t");
    arq.print("TD1"); arq.print("\t\t"); 
    arq.print("TD2"); arq.print("\t\t");
    arq.print("M1"); arq.print("\t\t"); 
    arq.print("M2"); arq.print("\t\t"); 
    arq.print("M3"); arq.print("\t\t"); 
    arq.print("M4"); arq.print("\t\t"); 
    arq.print("Drip"); arq.print("\t"); 
    arq.println("Sprinkler"); 
    arq.close();
   }
}  // end void setup
...
*/
         if (Lw == 1 && Mw == 1) {Dp = 1;} //L  Drip
         if (Lw == 1 && Tw == 1) {Spk = 1;} //L  Sprinkler
...
//        arq = SD.open("res.txt",FILE_WRITE);
  ...
  arq.print(day1); arq.print("/"); arq.print(month1); arq.print("/"); arq.print(year1); arq.print("\t"); arq.print("\t");
  arq.print(hour1); arq.print(":"); arq.print(mnt1); arq.print(":"); arq.print(sec1); arq.print("\t");
  arq.print(USav, 0); arq.print("\t"); arq.print(USsd, 0); arq.print("\t");
  arq.print(L2av, 0); arq.print("\t"); arq.print(L2sd, 0); arq.print("\t");
  arq.print(TD1av, 1); arq.print("\t"); arq.print(TD1sd, 1); arq.print("\t");
  arq.print(TD2av, 1); arq.print("\t"); arq.print(TD2sd, 1); arq.print("\t");
  arq.print(M1av, 0); arq.print("\t"); arq.print(M1sd, 0); arq.print("\t");
  arq.print(M2av, 0); arq.print("\t"); arq.print(M1sd, 0); arq.print("\t");
  arq.print(M3av, 0); arq.print("\t"); arq.print(M1sd, 0); arq.print("\t");
  arq.print(M4av, 0); arq.print("\t"); arq.print(M1sd, 0); arq.print("\t");   
  arq.print(Dp); arq.print("\t");    
  arq.print(Spk); arq.println("\t");   
...
void startDS()
{
  ...
  else 
  {
    ...
    sTD1 = 0.1; //(sensors.getResolution(DS0), DEC)/2.;  // intrinsic sensor precision: DS18B20_1 - temperature
    sTD2 = 0.1; //(sensors.getResolution(DS1), DEC)/2.;  // intrinsic sensor precision: DS18B20_2 - temperature
